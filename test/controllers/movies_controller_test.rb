...
describe MoviesController do
  ...
  describe "check_out" do
    it "can successfully check out a movie" do
      ...
      expect {
      post check_out_path, params: {customer: customer, movie: movie}
    ...
    it "does not check out a movie if customer has overdue items" do
      expect {
        post check_out_path, params: {customer: customertwo, movie: movie}
      }.wont_change "Rental.count", 1
    end
    ...
    it "does not check out a movie if rental information is invalid " do
      ...
      expect {
        post check_out_path, params: {movie: movie}
      }.wont_change "Rental.count", 1
